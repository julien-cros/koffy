...
export async function findSearchPost(
	...
	if (key === "all") return findPostWithAllKeys(key, value, isPrivate, user?.user.id);
...
async function findPostWithAllKeys(key: string, value: string | number, isPrivate: string, user: string | undefined) {
